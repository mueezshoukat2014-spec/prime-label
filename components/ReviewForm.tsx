      ...
      {!open ? (
        <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
          <button
            ...
            className="flex items-center gap-2 rounded-full border border-champagne/40 bg-champagne/[0.07] px-6 py-3 text-[13px] font-medium text-champagne transition-all duration-300 hover:bg-champagne/15"
          >
            <span aria-hidden>★</span> Worked with us? Share your experience
          </button>
          <a
            href="https://g.page/r/CYZM4--mhJyZEBM/review"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 rounded-full border border-line px-6 py-3 text-[13px] font-medium text-cream-muted transition-all duration-300 hover:border-champagne/50 hover:text-champagne"
          >
          ...
          {done ? (
            ...
            >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-5 inline-flex items-center gap-2 rounded-full border border-champagne/40 bg-champagne/10 px-5 py-2.5 text-[12.5px] font-medium text-champagne transition-colors hover:bg-champagne/20"
              >
                Loved working with us? Leave a Google review too →
              </a>
            </motion.div>
          ) : (
            <motion.form
