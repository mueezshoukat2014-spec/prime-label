...
const SEED_TESTIMONIALS = [
  // Real Google Business Profile reviews (https://g.page/r/CYZM4--mhJyZEBM),
  // reproduced with two typos corrected in the Lala Rukh entry; see the
  // note in lib/content.ts. Display only — never mark these up with Review or
  // aggregateRating; see the note in lib/seo.ts.
  ["Mueez Shoukat", "Verified Google review", "", "", "Outstanding experience! Got custom packaging and labels printed from them, and the quality is top-notch. The print sharpness, material, and finishing completely exceeded my expectations. Highly professional service and super fast delivery. 10/10 recommended!", 5],
  ["Muhammad Abdullah", "Verified Google review", "", "", "Outstanding quality and superb craftsmanship from Prime Labels! The labels turned out perfect with exact sizing and vibrant details. Extremely satisfied and highly recommended!", 5],
  ["Lala Rukh", "Verified Google review", "Cross&Crafts.pk", "", "They did very amazing. I was just curious about the labels, design and the perfect color that matches the vibe of Cross&Crafts.pk and they bring it very magically. Very nicely spoken and supportive. Will recommend 100000% to get your anything customized by them \u2764\ufe0f", 5],
  ["Muzamil Zafar", "Verified Google review", "", "", "I recently ordered labels from Prime Labels, and the quality is outstanding! The finishing and printing are top-notch. Fast delivery and excellent service\u2014highly recommended!", 5],
  ["malaika amjad", "Verified Google review", "", "", "I got my order exactly how i want it and tge quality was perfect 10/10, highly recommend", 5],
];
