...
const SEED_FAQS = [
  ...
  ["How do I get a price?", "Tap Request a Quote, tell us the product, quantity and any design details, and we will reply with a tailored quote. Because every order is custom, pricing depends on quantity, size and finish."],
